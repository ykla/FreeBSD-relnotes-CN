...
新增树莓派 3B 及部分 Compute Module 板卡上的 **bcm2835-virtgpio** GPIO 控制器驱动。可通过 [gpioled(4)](https://man.freebsd.org/cgi/man.cgi?query=gpioled&sektion=4&format=html) 控制 ACT（绿色）LED。[fb10574334ca](https://cgit.freebsd.org/src/commit/?id=fb10574334ca)。
