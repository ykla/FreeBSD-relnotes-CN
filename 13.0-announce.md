...
* 移除了安装到 **/usr/libexec** 供 [crashinfo(8)](https://man.freebsd.org/cgi/man.cgi?query=crashinfo&sektion=8&format=html) 使用的过时 GNU 调试器版本。可通过从 Ports 或 packages 安装现代 GDB 来获取详细的内核崩溃信息。
...
喜欢 FreeBSD？请通过向 The FreeBSD Foundation [捐赠](https://www.freebsdfoundation.org/donate/) 来支持本版本及未来版本！
