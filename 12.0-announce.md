...
许多公司捐赠了设备、网络访问或工时来支持 FreeBSD 12.0 的发布工程活动，包括 The FreeBSD Foundation、Yahoo!、NetApp、Internet Systems Consortium、ByteMark Hosting、Sentex Communications、New York Internet、Juniper Networks、NLNet Labs、iXsystems、CyberOne Data 和 National Chiao Tung University。
...
热爱 FreeBSD？请向 The FreeBSD Foundation [捐赠](https://www.freebsdfoundation.org/donate/) 以支持此版本及未来版本！
