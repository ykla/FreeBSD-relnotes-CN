# FreeBSD 5.4-RELEASE amd64 发行说明（2005 年 5 月 9 日）
...
驱动程序 [ndis(4)](http://www.freebsd.org/cgi/man.cgi?query=ndis&sektion=4&manpath=FreeBSD+5.4-RELEASE) 包装器现在支持在 amd64 系统上运行 Windows®/x86-64 二进制文件。
