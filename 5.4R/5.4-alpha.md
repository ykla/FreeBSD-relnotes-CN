# FreeBSD 5.4-RELEASE alpha 发行说明（2005 年 5 月 9 日）

- 原文链接：[FreeBSD/alpha 5.4-RELEASE Release Notes](https://www.freebsd.org/releases/5.4R/relnotes-alpha/)
...
本文档包含 FreeBSD 5.4-RELEASE 在 Alpha/AXP 硬件平台上的发行说明，介绍了 FreeBSD 最近新增、变更或删除的功能，并提供了从 FreeBSD 以前版本升级的相关说明。
