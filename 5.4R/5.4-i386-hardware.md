# FreeBSD 5.4-RELEASE i386 硬件兼容列表

- 原文链接：[FreeBSD/i386 5.4-RELEASE Hardware Notes](https://www.freebsd.org/releases/5.4R/hardware-i386/)
...
本文档包含 FreeBSD 5.4-RELEASE 在 i386 硬件平台（也称为 FreeBSD/i386 5.4-RELEASE）上的硬件兼容性说明。它列出了已知在此平台上工作的设备，以及一些在尝试为新设备配置支持时可能有用的引导时内核自定义说明。
...
注意，较旧的基于 ES18xx 芯片组的 ESS ISA 卡通过 **snd_ess(4)** 和/或 **snd_sbc(4)** 支持。
...
某些板载 CS4610 芯片附带 CS423x ISA codec 而非 CS4297 AC97 codec。**snd_csa(4)** 驱动程序尚不支持此类配置。
...
**ng_bt3c(4)** 驱动程序支持 3Com/HP 3CRWB6096-A PCCARD 蓝牙适配器。
