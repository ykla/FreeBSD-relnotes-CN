# FreeBSD 5.4-RELEASE pc98 发行说明（2005 年 5 月 9 日）

- 原文链接：[FreeBSD/pc98 5.4-RELEASE Release Notes](https://www.freebsd.org/releases/5.4R/relnotes-pc98/)
...
本文档包含 FreeBSD 5.4-RELEASE 在 NEC PC-98x1 硬件平台上的发行说明，介绍了 FreeBSD 最近新增、变更或删除的功能，并提供了从 FreeBSD 以前版本升级的相关说明。
