...
- 新增支持阻止以下内容：传入的 ICMP 重定向消息、发送的 RST 数据包以及传入的 SYN|FIN 数据包，从而减轻或消除某些类型的 DoS 攻击的影响。
...
- SCSI-I 和 SCSI-II 外围设备（硬盘、光盘、磁带机、介质交换器、处理器目标设备和 CD-ROM 驱动器）
...
FreeBSD 凝聚了来自世界各地的许多开发者的辛勤努力，他们辛勤工作，才有了今天这个版本。要查看完整的 FreeBSD 项目工作人员名单，请访问：[http://www.FreeBSD.org/handbook/staff.html](http://www.FreeBSD.org/handbook/staff.html)
