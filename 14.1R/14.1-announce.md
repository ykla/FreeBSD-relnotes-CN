# FreeBSD 14.1-RELEASE 发行公告

日期：2024 年 6 月 4 日

FreeBSD 发布工程团队很高兴地宣布 FreeBSD 14.1-RELEASE 现已发布。这是 **stable/14** 分支的第二个版本。

部分亮点：

* C 库现在在 amd64 上拥有字符串和内存操作的 SIMD 实现，提升了性能。

* 声音子系统的改进，包括设备热插拔。

* 初始的原生 cloud-init（配置驱动器）支持，兼容 OpenStack 和众多主机商。

* OpenZFS 升级到 2.2.4 版本。

* Clang/LLVM 升级到 18.1.5 版本。

* OpenSSH 升级到 9.7p1 版本。
...
FreeBSD 14.1-RELEASE 现已支持 amd64、i386、powerpc、powerpc64、powerpc64le、powerpcspe、armv7、aarch64 和 riscv64 架构。

FreeBSD 14.1-RELEASE 可从可启动 ISO 镜像或通过网络安装。部分架构还支持从 USB 闪存盘安装。所需文件可按以下说明下载。
...
FreeBSD 14.1-RELEASE 也可从多家供应商购买 DVD。以下供应商之一将提供基于 FreeBSD 14.1 的产品：
...
FreeBSD 14.1-RELEASE amd64 还可在以下云托管平台上使用：
...
FreeBSD 14.1-RELEASE 预计也将在 Google Compute Engine(TM) Marketplace 上架，待其完成第三方特定验证后：<https://console.cloud.google.com/marketplace/browse?filter=category:os&filter=price:free&q=freebsd>

* Microsoft Azure(TM):
FreeBSD 虚拟机镜像预计将在近期于 Azure Marketplace 上架：<https://azuremarketplace.microsoft.com/marketplace/apps/thefreebsdfoundation.freebsd-14_1>
...
FreeBSD 14.1-RELEASE 可通过 https 从以下站点下载：

* <https://download.freebsd.org/ftp/releases/ISO-IMAGES/14.1/>

FreeBSD 14.1-RELEASE 虚拟机镜像可从以下地址下载：

* <https://download.freebsd.org/ftp/releases/VM-IMAGES/14.1-RELEASE/>

FreeBSD 14.1-RELEASE amd64 BASIC-CI 镜像可从以下地址下载：

* <https://download.freebsd.org/ftp/releases/CI-IMAGES/14.1-RELEASE/>

有关安装 FreeBSD 或将现有机器更新到 14.1-RELEASE 的说明，请参阅：

* <https://www.FreeBSD.org/releases/14.1R/installation/>

## 支持

根据 FreeBSD 支持模型，FreeBSD 14 发行系列将至少支持到 2028 年 11 月 30 日。此点发行版 FreeBSD 14.1-RELEASE 将至少支持到 FreeBSD 14.2-RELEASE 发布后三个月。更多支持信息可在以下地址找到：

* <https://www.FreeBSD.org/security/>

请注意，14.0 将支持到 14.1 发行日期后三个月，即 2024 年 9 月 30 日。

## 致谢

多家公司为支持 FreeBSD 14.1 的发布工程活动捐赠了设备、网络访问或人力时间，包括：
...
| Colin Percival <cperciva@FreeBSD.org> | 发布工程负责人、14.1-RELEASE 发布工程师 |
...
喜欢 FreeBSD 吗？请通过向 FreeBSD 基金会[捐赠](https://www.freebsdfoundation.org/donate/) 来支持本版本及未来版本的发布！
