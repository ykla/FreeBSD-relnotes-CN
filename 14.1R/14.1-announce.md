...
FreeBSD 发布工程团队很高兴地宣布 FreeBSD 14.1-RELEASE 现已发布。
这是 **stable/14** 分支的第二个版本。
...
FreeBSD 14.1-RELEASE 可从可启动 ISO 镜像或通过网络安装。
部分架构还支持从 USB 闪存盘安装。
所需文件可按以下说明下载。
...
FreeBSD 14.1-RELEASE 也可从多家供应商购买 DVD。
以下供应商之一将提供基于 FreeBSD 14.1 的产品：
...
此点发行版 FreeBSD 14.1-RELEASE 将至少支持到 FreeBSD 14.2-RELEASE 发布后三个月。
更多支持信息可在以下地址找到：
...
喜欢 FreeBSD 吗？
请通过向 FreeBSD 基金会[捐赠](https://www.freebsdfoundation.org/donate/) 来支持本版本及未来版本的发布！
