...
FreeBSD 14.2-RELEASE 发行说明总结了在 14-STABLE 开发分支上 FreeBSD 基本系统的变更。本文档列出了自上次发布以来发布的适用安全公告，以及对 FreeBSD 内核和用户空间的重大变更。同时还附带了有关升级的简要说明。
...
| **FreeBSD-EN-24:12.killpg** | 2024 年 6 月 19 日 | killpg 中的锁定顺序倒置导致的活锁                                   |
| **FreeBSD-EN-24:13.libc++** | 2024 年 6 月 19 日 | 向堆分配的 `std::string` 删除传递了错误大小                         |
