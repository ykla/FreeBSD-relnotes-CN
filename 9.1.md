...
现已实现函数 [fdlopen(3)](https://man.freebsd.org/cgi/man.cgi?query=fdlopen&sektion=3&format=html)。这是个用于 [rtld(1)](https://man.freebsd.org/cgi/man.cgi?query=rtld&sektion=1&format=html) 通过文件涉及符加载共享对象的接口。[r230410](http://svn.freebsd.org/viewvc/base?view=revision&revision=230410)
