...
这是我们第一次发布 3.0-CURRENT 版本，主要面向早期采用者和开发者。一些文档内容可能尚未更新，如果遇到此类问题，请报告。当然，任何安装失败或崩溃也应尽快报告，可以通过发送邮件到 `freebsd-bugs@FreeBSD.org` 或使用 `send-pr` 命令来报告（喜欢基于网页的界面的人也可以查看此页面）。
...
**SCSI 外设支持：**
对所有支持的 SCSI 控制器提供完全支持，包括 SCSI-I 和 SCSI-II 外设，如硬盘、光盘、磁带机（包括 DAT 和 8mm Exabyte）、介质交换器、处理器目标设备和 CD-ROM 驱动器。
