...
* 除 Sossaman 外，所有多核 Intel Xeon(TM) 处理器均支持 EM64T。
...
* 部分使用 “Prescott” 核心的 Intel Pentium 4 和 Celeron D 支持 EM64T。关于 Intel 处理器对 EM64T 的支持情况，请参阅 [Intel Processor Spec Finder](http://processorfinder.intel.com) 以获取权威答案。
