...
> **注意**
>
> 虽然 [pci(4)](http://www.freebsd.org/cgi/man.cgi?query=pci&sektion=4&manpath=FreeBSD+5.3-RELEASE) 总线电源状态管理默认启用，但它可能会在某些系统上引发问题。可以通过将 tunable hw.pci.do_powerstate 设置为 0 来禁用它。
