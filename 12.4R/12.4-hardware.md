...
* Creative Sound Blaster Live! 24-Bit，被 FreeBSD 识别为
* Creative Sound Blaster Audigy LS / ES，被 FreeBSD 识别为
...
[amd64, i386] 支持多种 USB 外设；已知可工作的设备列于本节。由于大多数 USB 设备具有通用性，除少数例外，任何给定类别的设备均受支持，即使未在此明确列出。

> **注意**：
>
> [amd64, i386] USB 以太网适配器可在 [以太网接口](https://www.freebsd.org/releases/12.4R/hardware.html#ethernet) 章节中找到。

> **注意**：
>
> [amd64, i386] USB Bluetooth 适配器可在 [Bluetooth](https://www.freebsd.org/releases/12.4R/hardware.html#bluetooth) 章节中找到。
...
> **注意**：
>
> 关于特定显卡以及与 Xorg 兼容性的信息，可在 <http://www.x.org/> 查阅。
...
* [amd64, i386] PS/2 鼠标及兼容设备，包括许多笔记本定点设备（[psm(4)](https://man.freebsd.org/cgi/man.cgi?query=psm&sektion=4&format=html) 驱动）
* 串口鼠标及兼容设备
* [amd64, i386] USB 鼠标（[ums(4)](https://man.freebsd.org/cgi/man.cgi?query=ums&sektion=4&format=html) 驱动）

> **注意**：
>
> [moused(8)](https://man.freebsd.org/cgi/man.cgi?query=moused&sektion=8&format=html) 中有更多关于在 FreeBSD 中使用定点设备的信息。关于在 Xorg 中使用定点设备的信息，可在 <http://www.x.org/> 查阅。
