...
发行说明通常涉及 12.3-RELEASE 之后发布的安全公告、新的驱动或硬件支持、新命令或选项、主要的错误修复或第三方软件升级。文档可能还会列出主要的 Ports/软件包变更或发布工程实践改进。显然，发行说明无法列出每一个变更；本文档主要关注安全公告、用户可见的变更和主要的架构改进。
