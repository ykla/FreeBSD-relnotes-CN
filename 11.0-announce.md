...
dvd1::
包含安装 FreeBSD 基础操作系统、文档以及少量预构建 package（旨在启动图形工作站）所需的全部内容。
...
许多公司捐赠了设备、网络访问或人力时间来支持 FreeBSD 11.0 的发布工程活动，包括 The FreeBSD Foundation、Yahoo!、NetApp、Internet Systems Consortium、ByteMark Hosting、Sentex Communications、New York Internet、Juniper Networks、NLNet Labs、iXsystems 和 Yandex。
