...
FreeBSD 的核心不包含任何会妨碍其出口到美国以外地区的 DES 代码。核心发行版有一个附加软件包，仅供美国境内使用，其中包含通常使用 DES 的程序。提供的附加软件包可以供任何人使用。对于我们非美国用户，也有一个可以自由（从美国以外）出口的 DES 发行版，位于 [ftp://ftp.internat.FreeBSD.org/pub/FreeBSD](ftp://ftp.internat.FreeBSD.org/pub/FreeBSD)。
