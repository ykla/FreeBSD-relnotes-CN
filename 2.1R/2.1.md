...
从具有互联网邮件连接的机器提交错误报告的首选方法是使用 `send-pr` 命令。错误报告将由我们忠实的 bugfiler 程序妥善归档，你可以确信我们会尽最大努力尽快回应所有报告的错误。通过这种方式提交的错误报告也会在我们的网页上显示在支持部分，因此，它们不仅作为错误报告有价值，而且还作为“警示标志”，提醒其他用户注意潜在的问题。
