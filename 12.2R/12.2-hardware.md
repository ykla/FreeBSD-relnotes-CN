...
[amd64, i386] FreeBSD 支持多种 USB 外设；已知可正常工作的设备列于本节。由于大多数 USB 设备具有通用性，除少数例外，任何属于某一类别的设备均可获得支持，即使未在此明确列出。

> **注意**：
>
> [amd64, i386] USB 以太网适配器可在 [以太网接口](https://www.freebsd.org/releases/12.2R/hardware.html#ethernet) 章节中找到。

> **注意**：
>
> [amd64, i386] USB Bluetooth 适配器可在 [Bluetooth](https://www.freebsd.org/releases/12.2R/hardware.html#bluetooth) 章节中找到。
...
> **注意**：
>
> 关于特定显卡及其与 Xorg 兼容性的信息，可在 [www.x.org](http://www.x.org/) 查阅。
...
> **注意**：
>
> [moused(8)](https://man.freebsd.org/cgi/man.cgi?query=moused&sektion=8&format=html) 手册页提供了在 FreeBSD 中使用指点设备的更多信息。关于在 Xorg 中使用指点设备的信息，可在 [www.x.org](http://www.x.org/) 查阅。
...
[i386] 基于 Xilinx XC6200 的可重构硬件卡，与 [Virtual Computers](http://www.vcc.com/) 的 HOT1 兼容（xrpu 驱动）。
