...
FreeBSD 发布工程团队很高兴地宣布 FreeBSD 14.3-RELEASE 现已发布。
这是 stable/14 分支的第四个版本。
...
FreeBSD 14.3-RELEASE 可从可启动 ISO 镜像或通过网络安装。
部分架构还支持从 USB 闪存盘安装。
所需文件可按以下说明下载。
...
FreeBSD 14.3-RELEASE 还可从多家供应商购买 DVD 介质。
以下供应商将提供基于 FreeBSD 14.3 的产品：
...
* Google Compute Engine(TM):
  ...
  FreeBSD 镜像还可在 Google Compute Engine(TM) Marketplace 获取：
  <https://console.cloud.google.com/marketplace/browse?filter=category:os&filter=price:free&q=freebsd>

* Oracle Cloud Infrastructure:

  FreeBSD 镜像可在 Oracle Cloud Infrastructure Marketplace 获取，支持 amd64 和 aarch64 架构，包括 UFS 和 ZFS 文件系统：
  <https://cloudmarketplace.oracle.com/marketplace/app/freebsd-release>

* Microsoft Azure(TM):

  FreeBSD 镜像预计将在 Azure Marketplace 提供：
...
本版本 FreeBSD 14.3-RELEASE 将受支持至 2026 年 6 月 30 日。
上一版本 FreeBSD 14.2-RELEASE 将于 2025 年 9 月 30 日到达生命周期终点。
...
| | |
| :--- | :--- |
| [Amazon](https://www.amazon.com) | [FreeBSD 基金会](https://www.freebsdfoundation.org) |
| [Juniper Networks](https://www.juniper.net) | [New York Internet](https://www.nyi.net) |
...
喜爱 FreeBSD？
请向 FreeBSD 基金会[捐赠](https://www.freebsdfoundation.org/donate/) 以支持本版本及未来的发行版！
