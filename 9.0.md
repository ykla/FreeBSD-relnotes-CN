...
所有用户在安装 FreeBSD 之前，强烈建议查阅发行说明中的勘误（更正文档）。该文档包含了在发布周期结束或发布后发现的“最新变化”信息。通常，它包含已知的 bug、安全公告以及文档更正。您可以在 FreeBSD 网站上找到 FreeBSD 9.0-RELEASE 的最新勘误文档。
...
本节介绍了升级系统之前，您可能需要了解的显著不兼容性。**在提交问题报告/向 FreeBSD 邮件列表提问之前，请仔细阅读本节和[勘误文档](http://www.freebsd.org/releases/9.0R/勘误.html)。**
