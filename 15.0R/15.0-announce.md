...
. 发行版集合（传统方法）：这是先前 FreeBSD 发行版中使用的方法。
...
. 软件包（pkgbase / 新方法）：基本系统作为一组软件包从 “FreeBSD-base” 仓库安装。
...
* <https://www.FreeBSD.org/releases/15.0R/signatures/>

本公告的 PGP 签名版本可在以下地址获取：

* <https://www.FreeBSD.org/releases/15.0R/announce.asc>
...
我们预期以下供应商将提供基于 FreeBSD 15.0 的产品：
...
* <https://download.freebsd.org/releases/VM-IMAGES/15.0-RELEASE/>

FreeBSD 15.0-RELEASE BASIC-CI 镜像可从以下地址下载：

* <https://download.freebsd.org/releases/CI-IMAGES/15.0-RELEASE/>

FreeBSD 15.0-RELEASE OCI 容器镜像可从以下地址下载：

* <https://download.freebsd.org/releases/OCI-IMAGES/15.0-RELEASE/>
