...
工具 [date(1)](https://man.freebsd.org/cgi/man.cgi?query=date&sektion=1&format=html) 已支持纳秒。如： `date -Ins` 打印为 "2024-04-22T12:20:28,763742224+02:00"， `date +%N` 打印为 "415050400"。eeb04a736cb9
