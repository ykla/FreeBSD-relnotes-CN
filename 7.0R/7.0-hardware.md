...
* Intel Pentium 4 Processor supporting Intel EM64T (“Prescott”)。该处理器采用 90nm 工艺制造，使用 FC-LGA775 封装，工作频率为 3.20F/3.40F/3.60F GHz，搭配 Intel 925X Express 芯片组。对应的 S-Spec 编号为 SL7L9、SL7L8、SL7LA、SL7NZ、SL7PZ 和 SL7PX。注意，标号为 5xx 系列的处理器不支持 EM64T。
