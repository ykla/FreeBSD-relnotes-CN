...
[newsyslog(8)](https://www.freebsd.org/cgi/man.cgi?query=newsyslog&sektion=8&manpath=freebsd-release-ports) 工具已更新，以支持以符合 RFC5424 格式的方式记录到 [syslogd(8)](https://www.freebsd.org/cgi/man.cgi?query=syslogd&sektion=8&manpath=freebsd-release-ports)。更多信息请参见 [newsyslog.conf(5)](https://www.freebsd.org/cgi/man.cgi?query=newsyslog.conf&sektion=5&manpath=freebsd-release-ports) 中参数 `T` 的描述。[(r321263)](http://svn.freebsd.org/viewvc/base?view=revision&revision=321263)
