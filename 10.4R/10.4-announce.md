...
**FreeBSD/arm SD 卡镜像**：可写入 SD 卡并用于引导受支持的 arm 系统。SD 卡镜像包含完整的 FreeBSD 安装，可安装到小至 512Mb 的 SD 卡上。
...
* Amazon EC2(TM):
  ...
  AMI 完成第三方特定验证后，也将可在 Amazon Marketplace 中使用：<https://aws.amazon.com/marketplace/pp/B00KSS55FY/>
...
* Microsoft Azure(TM):
  FreeBSD 虚拟机镜像完成第三方特定验证后将在以下地址提供：<https://azuremarketplace.microsoft.com/marketplace/apps/Microsoft.FreeBSD104?tab=Overview>
