...
提交错误报告的首选方法是使用带有互联网邮件连接的机器上的 `send-pr` 命令，或使用 [http://www.FreeBSD.org/send-pr.html](http://www.FreeBSD.org/send-pr.html) 上的 CGI 脚本。我们忠实的 bugfiler 程序会妥善归档错误报告，你可以放心，我们会尽力尽快回复所有报告的错误。通过这种方式提交的错误报告也会出现在我们的网站支持部分，因此既作为错误报告，也为其他用户提供有关潜在问题的“路标”。
