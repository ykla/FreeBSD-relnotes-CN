...
- [bsdinstall(8)](https://man.freebsd.org/cgi/man.cgi?query=bsdinstall&sektion=8&format=html) 安装程序现在支持通过 HTTP 进行安装。[[r248313](http://svn.freebsd.org/viewvc/base?view=revision&revision=248313)]
...
- 添加服务特定的 [setfib(1)](https://man.freebsd.org/cgi/man.cgi?query=setfib&sektion=1&format=html) 支持。通过在 [rc.conf(5)](https://man.freebsd.org/cgi/man.cgi?query=rc.conf&sektion=5&format=html) 中设置 `<name>_fib` 来启用此功能。[[r253233](http://svn.FreeBSD.org/viewvc/base?view=revision&revision=253233)]
