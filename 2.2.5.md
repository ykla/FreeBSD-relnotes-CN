...
**注意：** 你不能从 SoundBlaster 卡引导系统，因为它们没有板载 BIOS，而 BIOS 是必需的，用于将启动设备映射到系统 BIOS I/O 向量。不过，这些卡完全可以用于外部磁带、CD-ROM 等设备。对于任何没有启动 ROM 的基于 AIC-6x60 的卡也是如此。有些系统确实带有启动 ROM，通常会在系统首次开机或重置时显示相关信息，在这种情况下，你也可以从这些卡引导。请检查你的系统/主板文档以了解更多细节。
...
FreeBSD 凝聚了全球数十甚至数百位个人的辛勤努力，他们为发布这个版本付出了巨大努力。有关 FreeBSD 项目工作人员的完整名单，请参阅：`http://www.FreeBSD.org/handbook/staff.html`
