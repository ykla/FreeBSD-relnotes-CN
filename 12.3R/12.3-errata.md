...
在安装本版本之前，务必查阅本文档，以了解发布后可能已发现并修复的问题。
...
| [FreeBSD-SA-22:11.vm](https://www.FreeBSD.org/security/advisories/FreeBSD-SA-22:11.vm.asc) | 2022 年 8 月 9 日 | 过时的虚拟内存映射导致的内存泄露 |
