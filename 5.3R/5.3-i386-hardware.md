# FreeBSD 5.3-RELEASE i386 硬件兼容列表

- 原文链接：[FreeBSD/i386 5.3-RELEASE Hardware Notes](https://www.freebsd.org/releases/5.3R/hardware-i386/)
...
本文档包含 FreeBSD 5.3-RELEASE 在 i386 硬件平台（也称为 FreeBSD/i386 5.3-RELEASE）上的硬件兼容性说明。它列出了已知在此平台上工作的设备，以及一些在尝试为新设备配置支持时可能有用的引导时内核自定义说明。
...
**hptmv(4)** 驱动程序支持 HighPoint RocketRAID 182x SATA 控制器。
...
> **注意**
>
> USB 以太网适配器可在 [以太网接口](https://www.freebsd.org/releases/5.3R/hardware-i386.html#ETHERNET) 小节中找到。

> **注意**
>
> USB 蓝牙适配器可在 [蓝牙设备](https://www.freebsd.org/releases/5.3R/hardware-i386.html#BLUETOOTH) 小节中找到。
