...
* [2015-08-16] 在 FreeBSD 10.3-RELEASE 发行说明中发现关于 `drm` 设备驱动程序的错误。r282199 的条目声明该驱动程序已更新以匹配 Linux(R) 3.8.13 版本，但该条目应注明此变更影响与设备无关的代码，并未使 `drm` 驱动程序完全符合所述 Linux(R) 版本。
