...
`mrouted` [rc(8)](http://www.freebsd.org/cgi/man.cgi?query=rc&sektion=8&manpath=freebsd-release-ports) 脚本已从基本系统中移除。等效的脚本可以通过 `net/mrouted` 端口获得。[(r275299)](http://svn.freebsd.org/viewvc/base?view=revision&revision=275299)
...
[readline(3)](http://www.freebsd.org/cgi/man.cgi?query=readline&sektion=3&manpath=freebsd-release-ports) 库现在在基本系统中静态链接，且不再安装共享库，这样 Ports Collection 可以使用库的现代版本。[(r268461)](http://svn.freebsd.org/viewvc/base?view=revision&revision=268461)
