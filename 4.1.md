...
您可以从以下地址订购 FreeBSD 4.1-RELEASE 和 3.x-RELEASE 版本的光盘：
...
每张 -RELEASE 版 CD 的费用为 39.95 美元，或使用 FreeBSD 订阅的情况下为 24.95 美元。  
FreeBSD SNAPshot 版 CD（如果有货）的费用为 39.95 美元，或使用 FreeBSD-SNAP 订阅的情况下为 14.95 美元。 （-RELEASE 和 -SNAP 订阅是完全独立的）。通过订阅，您将自动收到新发布的更新。每次发货时，您的信用卡将被扣费，您可以随时取消订阅，无需承担额外费用。
