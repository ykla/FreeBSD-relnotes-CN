...
* 原生和基于 LinuxKPI 的 WiFi 驱动程序修复了许多稳定性问题。
...
FreeBSD 13.3-RELEASE 现已支持 amd64、i386、powerpc、powerpc64、powerpc64le、powerpcspe、armv6、armv7、aarch64 和 riscv64 架构。
...
FreeBSD 13.3-RELEASE 预计也将在 Google Compute Engine(TM) Marketplace 上提供，待其完成第三方特定验证后可访问：
...
基于新的 FreeBSD 支持模型，FreeBSD 13 发行系列将支持至至少 2026 年 1 月 31 日。此版本 FreeBSD 13.3-RELEASE 将支持至至少 FreeBSD 13.4-RELEASE 发布后三个月。更多支持信息可在以下地址找到：
...
许多公司捐赠了设备、网络访问或人力时间，以支持 FreeBSD 13.3 的发布工程活动，包括：

| | |
| :--- | :--- |
| [FreeBSD 基金会](https://www.freebsdfoundation.org) | [Tarsnap](https://www.tarsnap.com) |
| [Sentex Data Communications](https://www.sentex.ca) | [New York Internet](https://www.nyi.net) |
| [365 Data Centers](https://365datacenters.com/) | [Juniper Networks](https://www.juniper.net) |
