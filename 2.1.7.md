...
- 提供用于简单 RAID 应用的磁盘驱动程序。更多信息请参见 ccd(4) 的手册页。
...
FreeBSD 是一款基于 4.4 BSD Lite 的免费发行版，适用于基于 Intel i386/i486/Pentium（或兼容）架构的 PC。它主要基于 U.C. Berkeley 的 CSRG 小组的软件，结合了一些来自 NetBSD、386BSD 和自由软件基金会的增强功能。
...
FreeBSD 的核心不包含任何会妨碍其出口到美国以外地区的 DES 代码。核心发行版有个附加包，仅供美国国内使用，包含通常使用 DES 的程序。单独提供的辅助包任何人都可以使用。对于非美国用户，FreeBSD 还提供了一个可自由出口的 DES 版本，下载地址为 ftp://ftp.internat.FreeBSD.org/pub/FreeBSD。
