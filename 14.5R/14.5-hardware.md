...
[FreeBSD/aarch64](/platforms/arm64) 将 64 位 ARM（ARMv9 和 ARMv8）作为 [Tier-1](https://docs.freebsd.org/en/articles/committers-guide/#archs) 架构。
...
[FreeBSD/armv7](/platforms/armv7) 将 32 位 ARM（ARM-v7 及以上）作为 [Tier-2](https://docs.freebsd.org/en/articles/committers-guide/#archs) 架构。
...
WORM/CD-R/CD-RW 写入支持由 [cdrecord(1)](https://man.freebsd.org/cgi/man.cgi?query=cdrecord&sektion=1&format=html) 提供，该程序是 Ports 中 `sysutils/cdrtools` Port 的组成部分。
...
从第四代起的 Intel Core(TM) 处理器、Intel
