# FreeBSD 13.4-RELEASE 发行公告

日期：2024 年 9 月 17 日

FreeBSD 发布工程团队很高兴地宣布 FreeBSD 13.4-RELEASE 现已发布。
这是 stable/13 分支的第五个版本。

由于本次发布处于旧版稳定分支的后期，新增功能较少；重点主要在于维护。
因此，自 13.3-RELEASE 以来的更改主要由缺陷修复、驱动程序更新和外部维护软件的新版本组成。
...
FreeBSD 13.4-RELEASE 现已支持 amd64、i386、powerpc、powerpc64、powerpc64le、powerpcspe、armv6、armv7、aarch64 和 riscv64 架构。

FreeBSD 13.4-RELEASE 可从可启动 ISO 镜像或通过网络安装。
部分架构还支持从 USB 闪存盘安装。
所需文件可按以下说明下载。
...
FreeBSD 13.4-RELEASE 还可在以下云托管平台上使用：

* FreeBSD/amd64 Amazon EC2(TM):

FreeBSD/amd64 EC2 AMI ID 可从各区域的 Systems Manager Parameter Store 中使用以下键获取：
...
FreeBSD/aarch64 EC2 AMI ID 可从各区域的 Systems Manager Parameter Store 中使用以下键获取：
...
FreeBSD 13.4-RELEASE 预计也将在 Google Compute Engine(TM) Marketplace 上提供，待其完成第三方特定验证后可访问：
<https://console.cloud.google.com/marketplace/browse?filter=category:os&filter=price:free&q=freebsd>

* Microsoft Azure(TM)：
FreeBSD 虚拟机镜像预计将在不久的将来在 Azure Marketplace 上提供：
...
FreeBSD 13.4-RELEASE 可通过 https 从以下站点下载：

* <https://download.freebsd.org/releases/ISO-IMAGES/13.4/>

FreeBSD 13.4-RELEASE 虚拟机镜像可从以下地址下载：

* <https://download.freebsd.org/releases/VM-IMAGES/13.4-RELEASE/>

FreeBSD 13.4-RELEASE BASIC-CI 镜像可从以下地址下载：

* <https://download.freebsd.org/releases/CI-IMAGES/13.4-RELEASE/>

有关安装 FreeBSD 或将现有机器更新至 13.4-RELEASE 的说明，请参阅：

* <https://www.FreeBSD.org/releases/13.4R/installation/>

## 支持

此版本 FreeBSD 13.4-RELEASE 将支持至 2025 年 6 月 30 日。
前一版本 FreeBSD 13.3-RELEASE 将于 2024 年 12 月 31 日到达生命周期终点。
...
许多公司捐赠了设备、网络访问或人力时间，以支持 FreeBSD 13.4 的发布工程活动，包括：

| | |
| :--- | :--- |
| [FreeBSD 基金会](https://freebsdfoundation.org/) | [Amazon](https://www.amazon.com/) |
| [Tarsnap](https://www.tarsnap.com/) | [Sentex Communications Corporation](https://home.sentex.ca/) |
| [New York Internet](https://www.nyi.net/) | [365 Data Centers](https://365datacenters.com/) |
| [Juniper Networks](https://www.juniper.net/) | |

13.4-RELEASE 的发布工程团队包括：
...
| Colin Percival <cperciva@FreeBSD.org> | 发布工程负责人、13.4-RELEASE 发布工程师 |
...
喜欢 FreeBSD？
请通过向 FreeBSD 基金会[捐赠](https://freebsdfoundation.org/donate/) 来支持本次及未来的发行版！
