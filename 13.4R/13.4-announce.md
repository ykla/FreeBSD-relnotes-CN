...
FreeBSD 发布工程团队很高兴地宣布 FreeBSD 13.4-RELEASE 现已发布。由于本次发布处于旧版稳定分支的后期，新增功能较少；重点主要在于维护。因此，自 13.3-RELEASE 以来的更改主要由缺陷修复、驱动程序更新和外部维护软件的新版本组成。
...
FreeBSD 13.4-RELEASE 可从可启动 ISO 镜像或通过网络安装。部分架构还支持从 USB 闪存盘安装。
...
FreeBSD 13.4-RELEASE 预计也将在 Google Compute Engine(TM) Marketplace 上提供，待其完成第三方特定验证后可访问：<https://console.cloud.google.com/marketplace/browse?filter=category:os&filter=price:free&q=freebsd>

* Microsoft Azure(TM)：FreeBSD 虚拟机镜像预计将在不久的将来在 Azure Marketplace 上提供：
...
此版本 FreeBSD 13.4-RELEASE 将支持至 2025 年 6 月 30 日。前一版本 FreeBSD 13.3-RELEASE 将于 2024 年 12 月 31 日到达生命周期终点。FreeBSD 13 发行系列将支持至 2026 年 4 月 30 日。更多支持信息可在以下地址找到：
...
| [Sentex Communications Corporation](https://home.sentex.ca/) |
...
喜欢 FreeBSD？请通过向 FreeBSD 基金会[捐赠](https://freebsdfoundation.org/donate/) 来支持本次及未来的发行版！
