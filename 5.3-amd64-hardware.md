# FreeBSD 5.3-RELEASE amd64 硬件兼容列表

- 原文链接：[FreeBSD/amd64 5.3-RELEASE Hardware Notes](https://www.freebsd.org/releases/5.3R/hardware-amd64/)
...
本文档包含 FreeBSD 5.3-RELEASE 在 AMD64 硬件平台（也称为 FreeBSD/amd64 5.3-RELEASE）上的硬件兼容性说明。它列出了已知在此平台上工作的设备，以及一些在尝试为新设备配置支持时可能有用的引导时内核自定义说明。
...
`twa(4)` 驱动程序支持以下 PATA/SATA RAID 控制器：
...
> **注意**
>
> USB 以太网适配器可在列出 [以太网接口](https://www.freebsd.org/releases/5.3R/hardware-amd64.html#ETHERNET) 的章节中找到。

> **注意**
>
> USB 蓝牙适配器可在 [蓝牙](https://www.freebsd.org/releases/5.3R/hardware-amd64.html#BLUETOOTH) 章节中找到。
