...
运行 `10.4-RELEASE` 或 `11.1-RELEASE` 的系统可按如下方式升级：
...
现在 [freebsd-update(8)](https://man.freebsd.org/cgi/man.cgi?query=freebsd-update&sektion=8&format=html) 工具可以获取属于 11.2-RELEASE 的内容。
