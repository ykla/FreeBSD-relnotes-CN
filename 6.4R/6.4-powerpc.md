# FreeBSD 6.4-RELEASE powerpc 发行说明（2008 年 11 月 28 日）

- 原文链接：[FreeBSD/powerpc 6.4-RELEASE Release Notes](https://www.freebsd.org/releases/6.4R/relnotes-powerpc/)
...
本文档包含 FreeBSD 6.4-RELEASE 在 PowerPC 硬件平台上的发行说明，介绍了 FreeBSD 最近添加、变更或删除的功能，并提供了从早期版本升级到 FreeBSD 的一些注意事项。
