...
FreeBSD 的核心不包含会妨碍其出口到美国以外地区的 DES 代码。对于仅在美国使用的用户，有附加包，包含了通常使用 DES 的程序。单独提供的辅助包任何人都可以使用。我们还为非美国用户提供了一个可以自由出口的 DES 版本，位于 [ftp://ftp.internat.FreeBSD.org/pub/FreeBSD](ftp://ftp.internat.FreeBSD.org/pub/FreeBSD)。
