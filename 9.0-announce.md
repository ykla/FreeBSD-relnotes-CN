...
*dvd1*：
包含安装 FreeBSD 基础操作系统、一组旨在让图形工作站快速运行起来的预构建软件包所需的全部内容。它还支持引导进入基于“livefs”的救援模式。如果你能刻录并使用 DVD 大小的介质，这应该就是你所需的全部。
...
许多公司捐赠了设备、网络接入或工时以支持 FreeBSD 9.0 的发行工程活动，包括 The FreeBSD Foundation、Yahoo!、NetApp、Internet Systems Consortium、Sentex Communications、New York Internet、Juniper Networks 和 iXsystems。
