...
为方便没有控制台访问权限的用户，默认提供 `freebsd` 用户（密码为 `freebsd`）用于 `ssh(1)` 访问。
...
许多公司捐赠了设备、网络访问或人力时间来支持 FreeBSD 10.3 的发布工程活动，包括 The FreeBSD Foundation、Yahoo!、NetApp、Internet Systems Consortium、ByteMark Hosting、Sentex Communications、New York Internet、Juniper Networks、NLNet Labs、iXsystems 和 Yandex。
