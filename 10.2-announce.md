...
* Linux(R) 兼容性版本已更新，支持 Centos(TM) 6 Ports。
* `drm` 代码已更新，匹配 Linux(R) 3.8.13 版本，允许同时运行多个 X 服务器。
...
许多公司捐赠了设备、网络访问或人力来支持 FreeBSD 10.2 的发布工程活动，包括 The FreeBSD Foundation、Yahoo!、NetApp、Internet Systems Consortium、ByteMark Hosting、Sentex Communications、New York Internet、Juniper Networks、NLNet Labs、iXsystems 和 Yandex。
...
此外，FreeBSD 发布工程团队还要感谢 Colin Percival (cperciva@) 在自动化 Amazon(R) EC2(TM) 镜像方面的工作，Steve Wills (swills@) 在 Google(R) Compute Engine(TM) 支持方面的工作，以及 Brad Davis (brd@) 在 Vagrant(TM) 支持方面的工作。
