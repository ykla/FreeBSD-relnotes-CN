...
从具有互联网邮件连接的机器提交错误报告的首选方法是使用 `send-pr` 命令。我们的忠实 bugfiler 程序将会认真地归档错误报告，你可以放心，我们会尽力尽快回应所有报告的错误。以这种方式提交的错误报告还可以在我们的网页支持部分查看，因此它们不仅是错误报告，也是其他用户警惕潜在问题的“路标”。
