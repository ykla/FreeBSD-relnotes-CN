...
FreeBSD 发布工程团队很高兴地宣布 FreeBSD 14.0-RELEASE 现已发布。这是 **stable/14** 分支的首个版本。
...
FreeBSD 14.0-RELEASE 可从可启动 ISO 镜像或通过网络安装。部分架构还支持从 USB 闪存盘安装。所需文件可按以下说明下载。
...
FreeBSD 14.0-RELEASE 也可从多家供应商购买 DVD。以下供应商之一将提供基于 FreeBSD 14.0 的产品：
...
将生成未压缩的 amd64 memstick 镜像文件。推荐下载压缩文件，因为这样速度更快且占用更少的网络带宽。

## 支持

根据 FreeBSD 支持模型，FreeBSD 14 发行系列将至少支持到 2028 年 11 月 30 日。此点发行版 FreeBSD 14.0-RELEASE 将至少支持到 FreeBSD 14.1-RELEASE 发布后三个月。更多支持信息可在以下地址找到：
