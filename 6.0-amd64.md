...
已新增一个加载器菜单选项，用于设置 `hint.atkbd.0.flags=0x1`。此设置允许在没有 PS/2 键盘连接的情况下使 USB 键盘正常工作。
...
已新增用于 [bsnmpd(1)](http://www.freebsd.org/cgi/man.cgi?query=bsnmpd&sektion=1&manpath=FreeBSD+6.0-RELEASE) 的 `rc.d/bsnmpd` 启动脚本。
