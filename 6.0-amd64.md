...
新增支持各种 Sony 笔记本电脑上 Sony Notebook Controller 的驱动程序 `acpi_sony`。
...
以下脚本移除了，因为它们是 NetBSD 特有且从未在 FreeBSD 中使用：`altqd`、`dhcpd`、`dhcrelay`、`downinterfaces`、`gated`、`ifwatchd`、`kdc`、`lkm1`、`lkm2`、`lkm3`、`mixerctl`、`mopd`、`mountall`、`ndbootd`、`network`、`poffd`、`postfix`、`ppp`、`racoon`、`raidframe`、`rbootd`、`rtsold`、`screenblank`、`swap2`、`sysdb`、`wscons`、`xdm` 和 `xfs`。
