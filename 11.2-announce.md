...
许多公司捐赠了设备、网络访问或人力时间来支持 FreeBSD 11.2 的发布工程活动，包括 The FreeBSD Foundation、Yahoo!、NetApp、Internet Systems Consortium、ByteMark Hosting、Sentex Communications、New York Internet、Juniper Networks、NLNet Labs、iXsystems 和 Yandex。
...
喜欢 FreeBSD？请通过向 The FreeBSD Foundation [捐赠](https://www.freebsdfoundation.org/donate/) 来支持此版本及未来版本的发布！
