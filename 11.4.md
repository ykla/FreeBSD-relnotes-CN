...
FreeBSD 11.4-RELEASE 的发行说明包含了在 11.4-STABLE 开发分支上对 FreeBSD 基本系统所做变更的总结。本文档列出了自上一个版本发布以来发布的相关安全公告，以及对 FreeBSD 内核和用户空间的重大变更。还简要介绍了升级的相关说明。

## 引言

本文档包含了 FreeBSD 11.4-RELEASE 的发行说明。它介绍了 FreeBSD 中最近添加、变更或删除的功能。还提供了一些关于从以前版本的 FreeBSD 升级的说明。
