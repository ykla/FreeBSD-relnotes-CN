...
典型的发行说明条目包括发布后 7.0-RELEASE 发布的安全公告、新的驱动程序或硬件支持、新的命令或选项、主要的错误修复，或第三方软件升级。它们也可能列出对主要 Port/包或发布工程实践的更改。显然，发行说明不能列出每个版本之间 FreeBSD 所做的每一项更改；本文档主要关注安全公告、用户可见的更改和主要的架构改进。
