...
[FreeBSD/aarch64](/platforms/arm) 将 64 位 ARM（ARMv9 和 ARMv8）作为 [Tier-1]({committers-guide}#archs) 架构。
...
[FreeBSD/armv7](/platforms/arm) 将 32 位 ARM（ARM-v7 及以上）作为 [Tier-2]({committers-guide}#archs) 架构。
...
驱动支持 Raspberry Pi 4 Model B 及相关系统上 Broadcom BCM2711
的以太网控制器部分。
它使用 BCM54213PE PHY。
...
自第四代起的 Intel(R) Core(TM) 处理器、Intel(R)
