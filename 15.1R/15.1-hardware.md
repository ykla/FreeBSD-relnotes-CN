# FreeBSD 15.1-RELEASE 硬件兼容列表

## 引言

本硬件兼容性说明列出所有已知可在 FreeBSD 15.1 上工作的硬件。
其他配置也可能可用，但尚未经过测试。
欢迎对本列表提出反馈、更新和修正！
...
驱动支持以下
Areca PCI-X/PCIe SATA/SAS/NVMe RAID 主机适配器：
...
[dwcotg(4)](https://man.freebsd.org/cgi/man.cgi?query=dwcotg&sektion=4&format=html)
驱动支持许多嵌入式设备中采用的 Synopsys DesignWare USB 控制器。
