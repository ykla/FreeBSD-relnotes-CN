...
在许多方面，FreeBSD/amd64 与 FreeBSD/i386 所支持的驱动类似。通常，已在其他 64 位平台上正常工作的驱动应该可用。
...
此架构有大量可选主板。使用 ISA、VLB、EISA、AGP 和 PCI 扩展总线的主板得到良好支持。对 IBM PS/2 系列 PC 中使用的 MCA（“MicroChannel”）扩展总线提供有限支持。
...
[i386] [da(4)](https://man.freebsd.org/cgi/man.cgi?query=da&sektion=4&format=html) 驱动支持以下控制器：
...
> **注意**：
>
> [amd64, i386, pc98] USB 以太网适配器可在列出 [以太网接口](https://www.freebsd.org/releases/11.0R/hardware.html#ethernet) 的章节中找到。

> **注意**：
>
> [amd64, i386, pc98] USB 蓝牙适配器可在 [Bluetooth](https://www.freebsd.org/releases/11.0R/hardware.html#bluetooth) 章节中找到。
