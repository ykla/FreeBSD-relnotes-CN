...
FreeBSD 发布工程团队很高兴地宣布 FreeBSD 13.5-RELEASE 现已发布。这是 stable/13 分支的第六个也是最终版本。

由于本次发布处于旧版稳定分支的后期，新增功能较少；重点主要在于维护。因此，自 13.4-RELEASE 以来的更改主要由缺陷修复、驱动程序更新和外部维护软件的新版本组成。
...
FreeBSD 13.5-RELEASE 可从可启动 ISO 镜像或通过网络安装。部分架构还支持从 USB 闪存盘安装。所需文件可按以下说明下载。
...
此点发行版 FreeBSD 13.5-RELEASE 将支持至 2026 年 4 月 30 日。前一个点发行版 FreeBSD 13.4-RELEASE 将于 2025 年 6 月 30 日到达生命周期终点。FreeBSD 13 发行系列将支持至 2026 年 4 月 30 日。更多支持信息可在以下地址找到：
...
喜欢 FreeBSD？请通过向 FreeBSD 基金会[捐赠](https://www.freebsdfoundation.org/donate/) 来支持本版本及未来的发行版！
