...
FreeBSD 支持 AMD64（“Hammer”）和 Intel EM64T 架构。AMD64（又称 x86-64）是受完全支持的 Tier 1 架构。AMD64 支持所有现代 x86 处理器。本发行版整合了多项优化和增强功能，以充分发挥基于 FreeBSD/amd64 系统的全部能力，在各种工作负载下提供更佳性能。
...
树莓派，更多支持信息请参阅 [树莓派 Wiki 页面](https://wiki.freebsd.org/arm/Raspberry%20Pi)：
...
`genet` 驱动支持 the 以太网 控制器 portion of the Broadcom BCM2711 on the 树莓派 4 Model B and related systems. It utilizes the BCM54213PE PHY。
...
**ig4** 支持基于 Synopsys DesignWare IP 的 I2C 控制器，这些控制器可见于第四代起的 Intel Core(TM) 处理器、Intel Bay Trail、Apollo Lake SoC 系列以及某些 AMD 系统。
