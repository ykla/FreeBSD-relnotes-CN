...
- 支持以太网媒体选择。替换了更为晦涩的 `link` 标志用法，`ifconfig` 中的新 `media` 标志允许通过名称选择多端口以太网卡上的特定接口（更多信息请参阅 `man ifconfig`）。
...
我们忠实的 bugfiler 程序会认真归档错误报告，你可以放心，我们会尽最大努力尽快响应所有报告的错误。通过这种方式提交的错误报告也将在我们的官网的支持部分显示，因此，它们不仅作为错误报告有价值，还为其他用户提供了潜在问题的“指示标记”。
...
此外，由于这是一个志愿者项目，我们始终欢迎更多人手来帮忙——目前我们期望的增强功能远远超出了我们自己能够处理的范围！
