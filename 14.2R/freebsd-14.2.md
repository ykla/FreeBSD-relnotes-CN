...
- 已新增对 ACPI GPIO _AEI 对象的支持。[1db6ffb2a482](https://cgit.freebsd.org/src/commit/?id=1db6ffb2a482)（由亚马逊赞助）
...
- [agp(4)](https://man.freebsd.org/cgi/man.cgi?query=agp&sektion=4&format=html) 已计划在 FreeBSD 15.0 中删除，手册页已标注为弃用。[92af7c97e197](https://cgit.freebsd.org/src/commit/?id=92af7c97e197)
- [syscons(4)](https://man.freebsd.org/cgi/man.cgi?query=syscons&sektion=4&format=html) 已计划在后续版本中删除，手册页已标注为弃用，建议用户迁移至 [vt(4)](https://man.freebsd.org/cgi/man.cgi?query=vt&sektion=4&format=html)。[2bc5b1d60512](https://cgit.freebsd.org/src/commit/?id=2bc5b1d60512)（由 FreeBSD 基金会赞助）
...
LinuxKPI（尤其是针对 802.11）的功能已增强，提高了无线驱动程序（如 [iwlwifi(4)](https://man.freebsd.org/cgi/man.cgi?query=iwlwifi&sektion=4&format=html)）的稳定性。（由 FreeBSD 基金会赞助）
...
已新增对 POWER10 和 POWER11 的初步支持。[f9f006df1535](https://cgit.freebsd.org/src/commit/?id=f9f006df1535)
...
软件包 [net/wifi-firmware-kmod@release](https://cgit.freebsd.org/ports/tree/net/wifi-firmware-kmod/) 已添加到 DVD 软件包中，以提供 WiFi 驱动所需固件。[8c6df7ead19c](https://cgit.freebsd.org/src/commit/?id=8c6df7ead19c)（由 FreeBSD 基金会赞助）
