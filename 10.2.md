...
本文件包含 FreeBSD 10.2-RELEASE 的发行说明，描述了 FreeBSD 最近新增、更改或移除的功能，并提供了从早期版本升级到当前版本的相关注意事项。
...
本文件描述了自 10.1-RELEASE 以来 FreeBSD 中对用户最显著的新功能或已更改功能。
...
本节涵盖对用户空间应用程序、第三方软件和系统工具的更改和新增内容。
...
本节涵盖物理机器、虚拟化环境及硬件虚拟化程序的通用硬件支持，以及无法归类到其他部分的硬件更改和更新。
