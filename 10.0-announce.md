...
> **重要**：
>
> _freebsd-update(8) 用户重要提示：_ 在将系统升级至 10.0-RELEASE 之前，请务必遵循以下 FreeBSD 勘误通知中的说明：
>
...
许多公司捐赠了设备、网络接入或工时以支持 FreeBSD 10.0 的发行工程活动，包括 The FreeBSD Foundation、Yahoo!、NetApp、Internet Systems Consortium、ByteMark Hosting、Sentex Communications、New York Internet、Juniper Networks、NLNet 和 iXsystems。
