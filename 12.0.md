...
>**重要**
>
> 在尝试升级 FreeBSD 之前，应先备份 _所有_ 数据和配置文件。
...
[bhyve(8)](https://man.freebsd.org/cgi/man.cgi?query=bhyve&sektion=8&format=html) 工具已更新，为 `-l` 和 `-s` 参数新增了 `help` 子命令，使用时会分别打印支持的 LPC 和 PCI 设备列表。[[r338210]](http://svn.freebsd.org/viewvc/base?view=revision&revision=338210)（由 iXsystems 赞助）
