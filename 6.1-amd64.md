...
工具 [**portsnap(8)**](http://www.freebsd.org/cgi/man.cgi?query=portsnap&sektion=8&manpath=FreeBSD+6.1-RELEASE) （`sysutils/portsnap`）已新增到 FreeBSD 基本系统中。这是一种安全、易用、快速、轻量且通常是保持 Ports 更新的良好方法。
