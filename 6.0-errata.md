...
（2005/11/5）6.0-RELEASE 中 **/usr/share/locale/\*/LC_\*** 文件磁盘格式的变更，会导致使用 [setlocale(3)](https://man.freebsd.org/cgi/man.cgi?query=setlocale&sektion=3&manpath=FreeBSD+6.0-RELEASE) 进行本地化的第三方软件在 5.x 系统升级后无法工作。这些软件包括通过 FreeBSD Ports Collection 等方式安装到 5.x 系统中的软件。要解决此问题，请执行以下操作之一：
