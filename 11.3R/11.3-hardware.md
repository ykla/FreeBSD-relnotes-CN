...
作为真正的 BusLogic MultiMaster 克隆的 AMI FastDisk 主机适配器也受 [bt(4)](https://man.freebsd.org/cgi/man.cgi?query=bt&sektion=4&format=html) 驱动支持。
...
[i386, amd64] [bce(4)](https://man.freebsd.org/cgi/man.cgi?query=bce&sektion=4&format=html) 驱动为基于 QLogic NetXtreme II Gigabit Ethernet 控制器系列的各种 NIC 提供支持，包括以下型号：
...
[i386, pc98, sparc64, amd64] [bge(4)](https://man.freebsd.org/cgi/man.cgi?query=bge&sektion=4&format=html) 驱动为基于 Broadcom BCM570x Gigabit Ethernet 控制器芯片系列的各种 NIC 提供支持，包括以下型号：
...
[i386, amd64] [bxe(4)](https://man.freebsd.org/cgi/man.cgi?query=bxe&sektion=4&format=html) 驱动为基于 QLogic NetXtreme II 10Gb Ethernet 控制器芯片系列的各种 NIC 提供支持，包括以下型号：
...
[i386, pc98, amd64, powerpc] [cdce(4)](https://man.freebsd.org/cgi/man.cgi?query=cdce&sektion=4&format=html) 驱动支持以下设备：
...
[i386, pc98, amd64, powerpc] [cue(4)](https://man.freebsd.org/cgi/man.cgi?query=cue&sektion=4&format=html) 驱动支持基于 CATC USB-EL1210A 的 USB 以太网适配器，包括：
...
[i386, pc98, amd64] [de(4)](https://man.freebsd.org/cgi/man.cgi?query=de&sektion=4&format=html) 驱动支持的适配器包括：
...
[i386] [e(4)](https://man.freebsd.org/cgi/man.cgi?query=e&sektion=4&format=html) 驱动支持基于 Intel i82586 芯片的以下 8 位和 16 位 ISA 以太网卡：
...
[i386, pc98, amd64, powerpc] [kue(4)](https://man.freebsd.org/cgi/man.cgi?query=kue&sektion=4&format=html) 驱动支持基于 Kawasaki LSI KL5KLUSB101B 的 USB 以太网适配器，包括：
...
[i386, amd64] [msk(4)](https://man.freebsd.org/cgi/man.cgi?query=msk&sektion=4&format=html) 驱动为基于 Marvell/SysKonnect Yukon II Gigabit Ethernet 控制器芯片系列的各种 NIC 提供支持，包括：
...
[i386, pc98, amd64] [pcn(4)](https://man.freebsd.org/cgi/man.cgi?query=pcn&sektion=4&format=html) 驱动支持基于 AMD PCnet/FAST、PCnet/FAST+、PCnet/FAST III、PCnet/PRO 和 PCnet/Home Fast Ethernet 芯片的适配器和嵌入式控制器：
...
[amd64] [qlxgb(4)](https://man.freebsd.org/cgi/man.cgi?query=qlxgb&sektion=4&format=html) 驱动支持基于以下芯片组的 10 Gigabit Ethernet 和 CNA 适配器：

* QLogic 3200 series
* QLogic 8200 series

[amd64] [qlxgbe(4)](https://man.freebsd.org/cgi/man.cgi?query=qlxgbe&sektion=4&format=html) 驱动支持基于以下芯片组的 10 Gigabit Ethernet 和 CNA 适配器：

* QLogic 8300 series

[amd64] [qlxge(4)](https://man.freebsd.org/cgi/man.cgi?query=qlxge&sektion=4&format=html) 驱动支持基于以下芯片组的 10 Gigabit Ethernet 和 CNA 适配器：
