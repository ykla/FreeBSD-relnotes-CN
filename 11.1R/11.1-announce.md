...
* 新增对 Microsoft Hyper-V(TM) 第二代虚拟机的支持。
* 新增 [ena(4)](https://man.freebsd.org/cgi/man.cgi?query=ena&sektion=4&format=html) 驱动程序，提供对 Amazon EC2(TM) 平台上“下一代”增强网络的支持。
* NFS 客户端现在支持 Amazon 弹性文件系统 (TM)（EFS）。
...
许多公司捐赠了设备、网络访问或人力时间来支持 FreeBSD 11.1 的发布工程活动，包括 FreeBSD 基金会、Yahoo!、NetApp、Internet Systems Consortium、ByteMark Hosting、Sentex Communications、New York Internet、Juniper Networks、NLNet Labs、iXsystems 和 Yandex。
