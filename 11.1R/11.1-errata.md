...
* [2017-07-21] 由于早期版本的 [clang(1)](https://man.freebsd.org/cgi/man.cgi?query=clang&sektion=1&format=html) 存在难以在升级过程中规避的缺陷，要通过 buildworld 从源代码升级系统至 -CURRENT 或 11.1-RELEASE，运行 9.x 的机器必须至少升级至修订 r286035，运行 10.x 的机器必须升级至修订 r286033。
