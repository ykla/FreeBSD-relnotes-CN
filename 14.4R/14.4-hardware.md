...
本硬件兼容性说明列出所有已知可在 FreeBSD 14.4 上工作的硬件。其他配置也可能可用，但尚未经过测试。欢迎对本列表提出反馈、更新和修正！
...
> **注意**：
>
> USB 蓝牙适配器参见 [蓝牙设备](https://www.freebsd.org/releases/14.4R/hardware.html#bluetooth)。USB 人机接口设备参见 [杂项](https://www.freebsd.org/releases/14.4R/hardware.html#misc)。USB 网络接口参见 [以太网接口](https://www.freebsd.org/releases/14.4R/hardware.html#ethernet) 或 [无线网络接口](https://www.freebsd.org/releases/14.4R/hardware.html#wlan)。USB 串行接口参见 [串行接口](https://www.freebsd.org/releases/14.4R/hardware.html#serial)。
