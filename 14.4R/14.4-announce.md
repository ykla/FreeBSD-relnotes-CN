# FreeBSD 14.4-RELEASE 发行公告

日期：2026 年 3 月 10 日

FreeBSD 发布工程团队很高兴地宣布 FreeBSD 14.4-RELEASE 现已发布。
这是 `stable/14` 分支的第五个版本。

部分亮点：

* OpenSSH 升级至 10.0p2 版本，并默认使用混合后量子算法 mlkem768x25519-sha256。

* OpenZFS 升级至 2.2.9 版本。

* nuageinit 的 cloud-init 兼容性显著改进。

* Bhyve 虚拟机现可通过新增的 p9fs(4) 与主机共享文件系统。
...
FreeBSD 项目将 FreeBSD 14.4-RELEASE 献给 Ken Smith 以示纪念，他于去年年底逝世。
Ken 曾担任 FreeBSD 发布工程负责人 7 年，负责 FreeBSD 6 到 FreeBSD 10 的发布。

## 获取途径

FreeBSD 14.4-RELEASE 现已支持 amd64、i386、aarch64、armv7、powerpc、powerpc64 和 riscv64 架构。

FreeBSD 14.4-RELEASE 可从可启动 ISO 镜像或通过网络安装。
部分架构还支持从 USB 闪存盘安装。
所需文件可按以下说明下载。
...
FreeBSD 14.4-RELEASE 还可在以下云托管平台上获取：
...
* Google Compute Engine(TM):
  ...
  FreeBSD 镜像也可在 Google Compute Engine(TM) Marketplace 获取：

  <https://console.cloud.google.com/marketplace/browse?filter=category:os&filter=price:free&q=freebsd>

* Microsoft Azure(TM):

  FreeBSD 虚拟机镜像预计即将在 Azure Marketplace 上提供：

  <https://azuremarketplace.microsoft.com/marketplace/apps/thefreebsdfoundation.freebsd-14_4>

## 下载

FreeBSD 14.4-RELEASE 可从以下站点通过 https 下载：

* <https://download.freebsd.org/releases/ISO-IMAGES/14.4/>

FreeBSD 14.4-RELEASE 虚拟机镜像可从以下地址下载：

* <https://download.freebsd.org/releases/VM-IMAGES/14.4-RELEASE/>

FreeBSD 14.4-RELEASE BASIC-CI 镜像可从以下地址下载：

* <https://download.freebsd.org/releases/CI-IMAGES/14.4-RELEASE/>

FreeBSD 14.4-RELEASE OCI 容器镜像可从以下地址下载：

* <https://download.freebsd.org/releases/OCI-IMAGES/14.4-RELEASE/>

也可在 Docker 和 GitHub 容器仓库中获取。

关于安装 FreeBSD 或将现有机器更新到 14.4-RELEASE 的说明，请参阅：

* <https://www.FreeBSD.org/releases/14.4R/installation/>

## 支持

本点版本 FreeBSD 14.4-RELEASE 将受支持至 2026 年 12 月 31 日。
上一版本 FreeBSD 14.3-RELEASE 将于 2026 年 6 月 30 日到达生命周期终点。
...
许多公司为支持 FreeBSD 14.4 的发布工程活动捐赠了设备、网络访问或人力，包括：

| | |
| :--- | :--- |
| [FreeBSD 基金会](https://www.freebsdfoundation.org) | [Juniper Networks](https://www.juniper.net) |
| [New York Internet](https://www.nyi.net) | [Open Sats Initiative](https://opensats.org) |
| [Sentex Data Communications](https://www.sentex.ca) | [Tarsnap](https://www.tarsnap.com) |
| [365 Data Centers](https://365datacenters.com/) | |

14.4-RELEASE 的发布工程团队包括：
...
| Colin Percival <cperciva@FreeBSD.org> | 发布工程负责人、14.4-RELEASE 发布工程师 |
...
喜欢 FreeBSD？
请向 FreeBSD 基金会[捐款](https://www.freebsdfoundation.org/donate/)，支持本次及未来的发行！
