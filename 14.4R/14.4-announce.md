...
FreeBSD 发布工程团队很高兴地宣布 FreeBSD 14.4-RELEASE 现已发布。这是 `stable/14` 分支的第五个版本。
...
FreeBSD 项目将 FreeBSD 14.4-RELEASE 献给 Ken Smith 以示纪念，他于去年年底逝世。Ken 曾担任 FreeBSD 发布工程负责人 7 年，负责 FreeBSD 6 到 FreeBSD 10 的发布。

## 获取途径

FreeBSD 14.4-RELEASE 现已支持 amd64、i386、aarch64、armv7、powerpc、powerpc64 和 riscv64 架构。

FreeBSD 14.4-RELEASE 可从可启动 ISO 镜像或通过网络安装。部分架构还支持从 USB 闪存盘安装。所需文件可按以下说明下载。
...
本点版本 FreeBSD 14.4-RELEASE 将受支持至 2026 年 12 月 31 日。上一版本 FreeBSD 14.3-RELEASE 将于 2026 年 6 月 30 日到达生命周期终点。FreeBSD 14 发布系列将受支持至 2028 年 11 月 30 日。更多支持信息可在以下地址找到：
...
| [Open Sats Initiative](https://opensats.org) |
...
喜欢 FreeBSD？请向 FreeBSD 基金会[捐款](https://www.freebsdfoundation.org/donate/)，支持本次及未来的发行！
